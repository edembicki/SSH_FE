      ...
      >
        ...
        <Row gutter={48}>
          <Col xs={24} sm={24} md={24} lg={4} xl={4}>
            ...
            <Card
              style={{ marginTop: 16, minHeight: '35vh' }}
            >
              <Timeline
                items={[
                  {
                    color: 'green',
                    children: 'You took 1 coin from the KFC store - 408 8th Ave',
                  },
                  {
                    color: 'green',
                    children: 'You took 1 coin from the KFC store - 408 8th Ave',
            ...
            >
              <Timeline
                items={[
                  {
                    color: 'red',
                    children: 'You spent coins 210.000 for claim KFC Ticket',
                  },
                  {
                    color: 'red',
                    children: 'You spent coins 210.000 for claim Burger King Ticket',
                  }
                ]}
              />
            </Card>
